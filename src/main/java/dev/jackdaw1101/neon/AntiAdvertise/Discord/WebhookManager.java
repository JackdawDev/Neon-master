...
public class WebhookManager {
    ...
    public WebhookManager(Neon plugin) {
        ...
        this.defaultWebhookUrl = (String) plugin.getDiscordManager().getDiscord("ANTI-LINK.URL", "");
        // Enable/disable the webhook from config
        this.isWebhookEnabled = (boolean) plugin.getDiscordManager().getValue("ANTI-LINK.ENABLED", false);
    }
    ...
    public void sendWebhook(Player player, String message, String type) {
        ...
        String title = (String) plugin.getDiscordManager().getDiscord("ANTI-LINK.FORMAT.title");
        ...
        List<String> descriptionLines = (List<String>) plugin.getDiscordManager().getValue("ANTI-LINK.FORMAT.description", new ArrayList<>());
    ...
    private String determineWebhookUrl() {
        ...
        if (this.defaultWebhookUrl.equalsIgnoreCase("GLOBAL")) {
            webhookUrl = (String) plugin.getDiscordManager().getDiscord("ANTI-LINK.URL", ""); // Global URL fallback
        }
    ...
    private String getColorForType(String type) {
        ...
        String colorCode = (String) plugin.getDiscordManager().getDiscord("ANTI-LINK.COLOR", "#ff0000"); // Default to red if not set
